...
Now, let’s quickly investigate the variables and how their distribution differs for the two classes. 
...
I am going to pick a random forest to predict conversion rate. I pick a random forest because: 
